...
void plotDiffQM25()
{
  ...
  drawArrow(fun_muB->Eval(27.0), y1+0.06, fun_muB->Eval(7.7), y1+0.06, 0.03, 30, 2, 1, 1, "<|>");
  drawText(fun_muB->Eval(17), y1+0.085, "BES-II COL", 52, 0.03);
  drawArrow(fun_muB->Eval(4.5), y1+0.06, fun_muB->Eval(3.0), y1+0.06, 0.03, 30, 2, 1, 1, "<|>");
  drawText(fun_muB->Eval(4.3), y1+0.085, "BES-II FXT", 52, 0.03);
  drawArrow(fun_muB->Eval(4.9), y1+0.18, fun_muB->Eval(2.0), y1+0.18, 0.03, 30, 2, 1, kGreen+3, "<|>");
  drawText(fun_muB->Eval(3.5), y1+0.205, "CBM", 52, 0.03, 0, kGreen+3);
  ...
  */
  ...
  c2->SaveAs("C42_muB_diff_QM25.png");  
  c2->SaveAs("C42_muB_diff_QM25.pdf");

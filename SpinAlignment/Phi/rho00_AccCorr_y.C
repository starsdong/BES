...
// Rapidity dependence
//////////////////////////////////////////////////////////////////////////////////////////////////////////
void rho00_AccCorr_y(const Double_t sigY = 9.9)
{
  style();
  ...
  c2->SaveAs(Form("fig/rho00_AccCorr_y_Y_%3.1f.pdf", sigY));
  c2->SaveAs(Form("fig/rho00_AccCorr_y_Y_%3.1f.png", sigY));
  
  TFile *fout = new TFile(Form("root/rho00_AccCorr_y_Y_%3.1f.root", sigY),"recreate");
  for(int i=0;i<NV2;i++) {
    gr[i]->Write();
    gr_corr[i]->Write();
  }

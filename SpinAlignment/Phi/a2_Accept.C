...
//////////////////////////////////////////////////////////////////////////////////////////////////////////
void a2_Accept(const Int_t iAccept = 3, const Double_t sigY = 9.9)
{
  style();
  ...
  c1->Update();
  c1->SaveAs(Form("fig/a2_fit_Accept_%d_Y_%3.1f.pdf", iAccept, sigY));
  c1->SaveAs(Form("fig/a2_fit_Accept_%d_Y_%3.1f.png", iAccept, sigY));  
  ...
  c2->SaveAs(Form("fig/a2_Accept_%d_pT_Y_%3.1f.pdf", iAccept, sigY));
  c2->SaveAs(Form("fig/a2_Accept_%d_pT_Y_%3.1f.png", iAccept, sigY));
  ...
  TFile *fout = new TFile(Form("root/drho_a2_Accept_%d_pT_Y_%3.1f.root", iAccept, sigY),"recreate");
  for(int i=0;i<NV2;i++) {
    gr[i]->Write();
    gr_drho[i]->Write();
    for(int j=0;j<NPt;j++) {
  ...
  c3->SaveAs(Form("fig/drho_a2_Accept_%d_pT_Y_%3.1f.pdf", iAccept, sigY));
  c3->SaveAs(Form("fig/drho_a2_Accept_%d_pT_Y_%3.1f.png", iAccept, sigY));

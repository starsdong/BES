...
void accept_Sergei_RPRes(const Double_t v2 = 0.1, const Double_t PsiRes = 0.5, const Double_t sigY = 5.0, const Int_t Nevt = 100000000)
{
  ...
  double EPRes = gr_res->Eval(PsiRes);
  cout << " Input Psi Res = " << PsiRes << "  EPRes = " << EPRes << " Input v2*Res = " << v2*EPRes << endl;
  
  TF1 *fPhi = new TF1("fPhi","1. + 2.*[0]*cos(2.*x)", 0, TMath::Pi()*2.0);
  //  fPhi->SetParameter(0, 0.1);
  //  fPhi->SetParameter(0, v2*EPRes);
  ...
  TH2D *hPtCosTheta2 = new TH2D("hPtCosTheta2","",200,0.,10.,1000,0.,1.);  // delta_rho00 = 5/2 * (<cos^2theta*> - 1/3)
  TH2D *hPtCos2PhiRPT = new TH2D("hPtCos2PhiRPT","",200,0.,10.,2000,-1.,1.); // delta_rho00 = -4/3 * <cos(2*(phi*-Psi_RP))> - alternative calculation
  TH2D *hPtCosTheta2T = new TH2D("hPtCosTheta2T","",200,0.,10.,1000,0.,1.);  // delta_rho00 = 5/2 * (<cos^2theta*> - 1/3)
  ...
  TH2D *hYCos2PhiRPT = new TH2D("hYCos2PhiRPT","",20,0.,1.,2000,-1.,1.);
  TH2D *hYCosTheta2T = new TH2D("hYCosTheta2T","",20,0.,1.,1000,0.,1.);
  ...
  TH2D *hPtCos2PhiRPRcT = new TH2D("hPtCos2PhiRPRcT","",200,0.,10.,2000,-1.,1.);  // calculation w.r.t. the true EP (unsmeared)
  TH2D *hPtCosTheta2RcT = new TH2D("hPtCosTheta2RcT","",200,0.,10.,1000,0.,1.);
  ...
  TH2D *hYCos2PhiRPRcT = new TH2D("hYCos2PhiRPRcT","",20,0.,1.,2000,-1.,1.);
  TH2D *hYCosTheta2RcT = new TH2D("hYCosTheta2RcT","",20,0.,1.,1000,0.,1.);
  ...
  TH2D *hPtCos2PhiRPRc1T = new TH2D("hPtCos2PhiRPRc1T","",200,0.,10.,2000,-1.,1.);
  TH2D *hPtCosTheta2Rc1T = new TH2D("hPtCosTheta2Rc1T","",200,0.,10.,1000,0.,1.);
  ...
  TH2D *hYCos2PhiRPRc1T = new TH2D("hYCos2PhiRPRc1T","",20,0.,1.,2000,-1.,1.);
  TH2D *hYCosTheta2Rc1T = new TH2D("hYCosTheta2Rc1T","",20,0.,1.,1000,0.,1.);
  ...
  TH2D *hPtCos2PhiRPRc2T = new TH2D("hPtCos2PhiRPRc2T","",200,0.,10.,2000,-1.,1.);
  TH2D *hPtCosTheta2Rc2T = new TH2D("hPtCosTheta2Rc2T","",200,0.,10.,1000,0.,1.);
  ...
  TH2D *hYCos2PhiRPRc2T = new TH2D("hYCos2PhiRPRc2T","",20,0.,1.,2000,-1.,1.);
  TH2D *hYCosTheta2Rc2T = new TH2D("hYCosTheta2Rc2T","",20,0.,1.,1000,0.,1.);
  ...
  TH2D *hPtCos2PhiRPRc3T = new TH2D("hPtCos2PhiRPRc3T","",200,0.,10.,2000,-1.,1.);
  TH2D *hPtCosTheta2Rc3T = new TH2D("hPtCosTheta2Rc3T","",200,0.,10.,1000,0.,1.);
  ...
  TH2D *hYCos2PhiRPRc3T = new TH2D("hYCos2PhiRPRc3T","",20,0.,1.,2000,-1.,1.);
  TH2D *hYCosTheta2Rc3T = new TH2D("hYCosTheta2Rc3T","",20,0.,1.,1000,0.,1.);
  ...
  TH2D *hPtCos2PhiRPRc4T = new TH2D("hPtCos2PhiRPRc4T","",200,0.,10.,2000,-1.,1.);
  TH2D *hPtCosTheta2Rc4T = new TH2D("hPtCosTheta2Rc4T","",200,0.,10.,1000,0.,1.);
  ...
  TH2D *hYCos2PhiRPRc4T = new TH2D("hYCos2PhiRPRc4T","",20,0.,1.,2000,-1.,1.);
  TH2D *hYCosTheta2Rc4T = new TH2D("hYCosTheta2Rc4T","",20,0.,1.,1000,0.,1.);
  ...
  for(int ievt = 0; ievt<Nevt; ievt++) {
    ...
    double Psi_RP = gRandom->Gaus(Psi_RP_0, PsiRes);
    ...
    TVector3 L_unitT(TMath::Cos(Psi_RP_0 + TMath::Pi()*0.5), TMath::Sin(Psi_RP_0 + TMath::Pi()*0.5), 0);
    double costheta_rcT = K1momStar.Vect().Dot(L_unitT)/K1momStar.Vect().Mag();
    if(fabs(y)<1.0) {
      hPtCosTheta->Fill(pT, costheta_rc);
      hPtCos2Phi->Fill(pT, cos2phi);
      hPtV2->Fill(pT, TMath::Cos(2.*(phi - Psi_RP)));
      hPtCos2PhiRP->Fill(pT, TMath::Cos(2.*(phi_star - Psi_RP)));
      hPtCosTheta2->Fill(pT, costheta_rc*costheta_rc);
      hPtCos2PhiRPT->Fill(pT, TMath::Cos(2.*(phi_star - Psi_RP_0)));
      hPtCosTheta2T->Fill(pT, costheta_rcT*costheta_rcT);
	...
	hYCos2PhiRPT->Fill(fabs(y), TMath::Cos(2.*(phi_star - Psi_RP_0)));
	hYCosTheta2T->Fill(fabs(y), costheta_rcT*costheta_rcT);
      }
    }
	...
	hPtCos2PhiRPRcT->Fill(pT, TMath::Cos(2.*(phi_star - Psi_RP_0)));
	hPtCosTheta2RcT->Fill(pT, costheta_rcT*costheta_rcT);
	...
	if(pT>1.2 && pT<5.4) {
	  ...
	  hYCos2PhiRPRcT->Fill(fabs(y), TMath::Cos(2.*(phi_star - Psi_RP_0)));
	  hYCosTheta2RcT->Fill(fabs(y), costheta_rcT*costheta_rcT);
	}
      }
	...
	if(fabs(y)<1.0) {
	  ...
	  hPtCos2PhiRPRc1T->Fill(pT, TMath::Cos(2.*(phi_star - Psi_RP_0)));
	  hPtCosTheta2Rc1T->Fill(pT, costheta_rcT*costheta_rcT);
	  ...
	  if(pT>1.2 && pT<5.4) {
	    ...
	    hYCos2PhiRPRc1T->Fill(fabs(y), TMath::Cos(2.*(phi_star - Psi_RP_0)));
	    hYCosTheta2Rc1T->Fill(fabs(y), costheta_rcT*costheta_rcT);
	  }
	}
	...
	if(gRandom->Rndm()<gr_eff_tpc->Eval(K1mom.Pt()) &&
	  ...
	  if(fabs(y)<1.0) {
	    ...
	    hPtCos2PhiRPRc2T->Fill(pT, TMath::Cos(2.*(phi_star - Psi_RP_0)));
	    hPtCosTheta2Rc2T->Fill(pT, costheta_rcT*costheta_rcT);
	    ...
	    if(pT>1.2 && pT<5.4) {
	      ...
	      hYCos2PhiRPRc2T->Fill(fabs(y), TMath::Cos(2.*(phi_star - Psi_RP_0)));
	      hYCosTheta2Rc2T->Fill(fabs(y), costheta_rcT*costheta_rcT);
	    }
	  }
	  ...
	  if(gRandom->Rndm()<gr_eff_tof->Eval(K1mom.Pt()) &&
	    ...
	    if(fabs(y)<1.0) {
	      ...
	      hPtCos2PhiRPRc3T->Fill(pT, TMath::Cos(2.*(phi_star - Psi_RP_0)));
	      hPtCosTheta2Rc3T->Fill(pT, costheta_rcT*costheta_rcT);
		...
		hYCos2PhiRPRc3T->Fill(fabs(y), TMath::Cos(2.*(phi_star - Psi_RP_0)));
		hYCosTheta2Rc3T->Fill(fabs(y), costheta_rcT*costheta_rcT);
	      }
	    }
	  }	  
  ...
  TFile *fout = new TFile(Form("accept_Sergei_v2_%3.1f_res_%3.1f_Y_%3.1f.root",v2,PsiRes,sigY),"recreate");
  hPtY->Write();
  hPtEta->Write();
  hPtCosTheta->Write();
  hPtCos2Phi->Write();
  ...
  hPtCos2PhiRPRcT->Write();
  hPtCosTheta2RcT->Write();
  hYCosThetaRc->Write();
  hYCos2PhiRc->Write();
  hYCos2PhiRPRc->Write();
  hYCosTheta2Rc->Write();
  hYCos2PhiRPRcT->Write();
  hYCosTheta2RcT->Write();
  ...
  hPtCos2PhiRPRc1T->Write();
  hPtCosTheta2Rc1T->Write();
  hYCosThetaRc1->Write();
  hYCos2PhiRc1->Write();
  hYCos2PhiRPRc1->Write();
  hYCosTheta2Rc1->Write();
  hYCos2PhiRPRc1T->Write();
  hYCosTheta2Rc1T->Write();
  ...
  hPtCos2PhiRPRc2T->Write();
  hPtCosTheta2Rc2T->Write();
  hYCosThetaRc2->Write();
  hYCos2PhiRc2->Write();
  hYCos2PhiRPRc2->Write();
  hYCosTheta2Rc2->Write();
  hYCos2PhiRPRc2T->Write();
  hYCosTheta2Rc2T->Write();
  ...
  hPtCos2PhiRPRc3T->Write();
  hPtCosTheta2Rc3T->Write();
  hYCosThetaRc3->Write();
  hYCos2PhiRc3->Write();
  hYCos2PhiRPRc3->Write();
  hYCosTheta2Rc3->Write();
  hYCos2PhiRPRc3T->Write();
  hYCosTheta2Rc3T->Write();
  ...
  hPtCos2PhiRPRc4T->Write();
  hPtCosTheta2Rc4T->Write();
  hYCosThetaRc4->Write();
  hYCos2PhiRc4->Write();
  hYCos2PhiRPRc4->Write();
  hYCosTheta2Rc4->Write();
  hYCos2PhiRPRc4T->Write();
  hYCosTheta2Rc4T->Write();

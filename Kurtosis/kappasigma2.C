...
void kappasigma2(const Int_t config=1){
  style();
  ...
  drawText(65, y1+(y2-y1)*0.74, " ref: HRG-CE/UrQMD",12,0.04);
  ...
  drawText(-10, y1+(y2-y1)*0.74, " ref: HRG-CE/UrQMD",12,0.04);
